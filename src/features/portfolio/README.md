...
Demo code should not import from main-site components unless the dependency is intentionally shared and documented.

Demo-specific animation and browser behavior should live with the demo entry, not in global page scripts.