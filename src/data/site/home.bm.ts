...
export const packages = [
  {
    ...
    tiers: [
      { name: "Basic", price: "RM499", scope: "Satu landing page, CTA WhatsApp, asas SEO", meta: "1 semakan / 3-5 hari bekerja" },
      { name: "Plus", price: "RM799", scope: "Copy flow lebih kuat, motion asas, polish tambahan", meta: "2 semakan / 5-7 hari bekerja" },
      { name: "Pro", price: "RM1,199", scope: "Landing page premium dengan section lebih mendalam", meta: "3 semakan / 7-10 hari bekerja" },
    ],
  ...
  },
  {
    ...
    tiers: [
      { name: "Basic", price: "RM999", scope: "Website bisnes lima halaman dengan struktur servis dan laluan contact jelas", meta: "1 semakan / 7-10 hari bekerja" },
      { name: "Plus", price: "RM1,499", scope: "Website tujuh halaman dengan section servis, pasukan, dan bukti lebih kuat", meta: "2 semakan / 10-14 hari bekerja", recommended: true },
      { name: "Pro", price: "RM2,499", scope: "Sehingga sepuluh halaman dengan perincian servis mendalam, portfolio, dan kajian kes", meta: "3 semakan / 14-18 hari bekerja" },
    ],
    note: "Client sediakan aset jenama, content servis, dan gambar. Bantuan copywriting boleh diminta jika perlu.",
  },
  {
    name: "Custom Build",
    price: "Bermula RM2,499",
    ...
    tiers: [
      { name: "Plus", price: "RM2,499", scope: "Website custom dengan booking atau perancangan integrasi", meta: "3 semakan / 3-4 minggu" },
      { name: "Pro", price: "RM4,999+", scope: "Projek custom lebih besar dengan support launch lebih mendalam", meta: "Scope selepas discovery" },
    ],
