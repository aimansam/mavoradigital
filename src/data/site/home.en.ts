...
export const packages = [
  {
    ...
    tiers: [
      { name: "Basic", price: "RM499", scope: "One landing page, WhatsApp CTA, basic SEO", meta: "1 revision / 3-5 working days" },
      { name: "Plus", price: "RM799", scope: "Stronger copy flow, basic motion, extra polish", meta: "2 revisions / 5-7 working days" },
      { name: "Pro", price: "RM1,199", scope: "Premium landing page with deeper sections", meta: "3 revisions / 7-10 working days" },
    ],
  ...
  },
  {
    ...
    tiers: [
      { name: "Basic", price: "RM999", scope: "Five-page business website with service structure and clear contact paths", meta: "1 revision / 7-10 working days" },
      { name: "Plus", price: "RM1,499", scope: "Seven-page site with stronger service sections, team, and proof", meta: "2 revisions / 10-14 working days", recommended: true },
      { name: "Pro", price: "RM2,499", scope: "Up to ten pages with deep service detail, portfolio, and case studies", meta: "3 revisions / 14-18 working days" },
    ],
  ...
  },
  {
    ...
    tiers: [
      { name: "Plus", price: "RM2,499", scope: "Custom website with booking or integration planning", meta: "3 revisions / 3-4 weeks" },
      { name: "Pro", price: "RM4,999+", scope: "Larger custom project with deeper launch support", meta: "Scoped after discovery" },
    ],
